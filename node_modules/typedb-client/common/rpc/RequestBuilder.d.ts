...
import { ConceptValue as ConceptValueProto, ConceptValue, Thing as ThingProto, Type as TypeProto, ValueType as ValueTypeProto } from "typedb-protocol/common/concept_pb";
...
export declare namespace RequestBuilder {
    ...
    namespace Connection {
        function openReq(): ConnectionProto.Open.Req;
    }
    namespace Session {
    ...
    namespace ConceptManager {
        ...
        function putAttributeTypeReq(label: string, valueType: ValueTypeProto): TransactionProto.Req;
        function getThingTypeReq(label: string): TransactionProto.Req;
        function getThingReq(iid: string): TransactionProto.Req;
    }
    namespace Concept {
        function conceptValueBooleanProto(value: boolean): ConceptValue;
        function conceptValueLongProto(value: number): ConceptValueProto;
        function conceptValueDoubleProto(value: number): ConceptValueProto;
        function conceptValueStringProto(value: string): ConceptValueProto;
        function conceptValueDateTimeProto(value: Date): ConceptValueProto;
    }
    namespace Type {
        ...
        namespace ThingType {
            ...
            function getOwnsReq(label: Label, annotations: TypeProto.Annotation[]): TransactionProto.Req;
            function getOwnsByTypeReq(label: Label, valueType: ValueTypeProto, annotations: TypeProto.Annotation[]): TransactionProto.Req;
            function getOwnsExplicitReq(label: Label, annotations: TypeProto.Annotation[]): TransactionProto.Req;
            function getOwnsExplicitByTypeReq(label: Label, valueType: ValueTypeProto, annotations: TypeProto.Annotation[]): TransactionProto.Req;
            function setOwnsReq(label: Label, attributeType: TypeProto, annotations: TypeProto.Annotation[]): TransactionProto.Req;
            function setOwnsOverriddenReq(label: Label, attributeType: TypeProto, overriddenType: TypeProto, annotations: TypeProto.Annotation[]): TransactionProto.Req;
        ...
        namespace AttributeType {
            function getOwnersReq(label: Label, annotations: TypeProto.Annotation[]): TransactionProto.Req;
            function getOwnersExplicitReq(label: Label, annotations: TypeProto.Annotation[]): TransactionProto.Req;
            function putReq(label: Label, value: ConceptValueProto): TransactionProto.Req;
            function getReq(label: Label, value: ConceptValueProto): TransactionProto.Req;
        ...
        namespace Annotation {
            function annotationKeyProto(): TypeProto.Annotation;
            function annotationUniqueProto(): TypeProto.Annotation;
        }
    }
    namespace Thing {
        function protoThing(iid: string): ThingProto;
        function getHasReqByAnnotations(iid: string, annotations: TypeProto.Annotation[]): TransactionProto.Req;
