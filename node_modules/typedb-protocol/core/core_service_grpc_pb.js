...
var common_connection_pb = require('../common/connection_pb.js');
var common_session_pb = require('../common/session_pb.js');
var common_transaction_pb = require('../common/transaction_pb.js');

function serialize_typedb_protocol_Connection_Open_Req(arg) {
  if (!(arg instanceof common_connection_pb.Connection.Open.Req)) {
    throw new Error('Expected argument of type typedb.protocol.Connection.Open.Req');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_Connection_Open_Req(buffer_arg) {
  return common_connection_pb.Connection.Open.Req.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_typedb_protocol_Connection_Open_Res(arg) {
  if (!(arg instanceof common_connection_pb.Connection.Open.Res)) {
    throw new Error('Expected argument of type typedb.protocol.Connection.Open.Res');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_typedb_protocol_Connection_Open_Res(buffer_arg) {
  return common_connection_pb.Connection.Open.Res.deserializeBinary(new Uint8Array(buffer_arg));
}
...
connection_open: {
    ...
    requestType: common_connection_pb.Connection.Open.Req,
    responseType: common_connection_pb.Connection.Open.Res,
    requestSerialize: serialize_typedb_protocol_Connection_Open_Req,
    requestDeserialize: deserialize_typedb_protocol_Connection_Open_Req,
    responseSerialize: serialize_typedb_protocol_Connection_Open_Res,
    responseDeserialize: deserialize_typedb_protocol_Connection_Open_Res,
  },
