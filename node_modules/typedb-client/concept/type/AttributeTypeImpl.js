...
var Annotation = ThingType_1.ThingType.Annotation;
...
class AttributeTypeImpl extends dependencies_internal_1.ThingTypeImpl {
    ...
    get valueType() {
        return Concept_1.Concept.ValueType.OBJECT;
    }
    isAttributeType() {
        return true;
    }
...
(function (AttributeTypeImpl) {
    function of(attributeTypeProto) {
        ...
        switch (attributeTypeProto.getValueType()) {
            ...
            case concept_pb_1.ValueType.OBJECT:
    ...
    class Remote extends dependencies_internal_1.ThingTypeImpl.Remote {
        ...
        getOwners(annotations) {
            const request = RequestBuilder_1.RequestBuilder.Type.AttributeType.getOwnersReq(this.label, annotations ? annotations.map(a => Annotation.proto(a)) : []);
        ...
        getOwnersExplicit(annotations) {
            const request = RequestBuilder_1.RequestBuilder.Type.AttributeType.getOwnersExplicitReq(this.label, annotations ? annotations.map(a => Annotation.proto(a)) : []);
            return this.stream(request)
                .flatMap((resPart) => Stream_1.Stream.array(resPart.getAttributeTypeGetOwnersExplicitResPart().getThingTypesList()))
                .map((thingTypeProto) => dependencies_internal_1.ThingTypeImpl.of(thingTypeProto));
        }
        getImpl(conceptValueProto) {
            const request = RequestBuilder_1.RequestBuilder.Type.AttributeType.getReq(this.label, conceptValueProto);
    ...
    class Boolean extends AttributeTypeImpl {
        ...
        get valueType() {
            return Concept_1.Concept.ValueType.BOOLEAN;
        }
        isBoolean() {
            return true;
        }
    ...
    (function (Boolean) {
        class Remote extends AttributeTypeImpl.Remote {
            ...
            async get(value) {
                return await super.getImpl(RequestBuilder_1.RequestBuilder.Concept.conceptValueBooleanProto(value));
            }
            getInstances() {
                return super.getInstances();
            }
            ...
            async put(value) {
                const request = RequestBuilder_1.RequestBuilder.Type.AttributeType.putReq(this.label, RequestBuilder_1.RequestBuilder.Concept.conceptValueBooleanProto(value));
    ...
    class Long extends AttributeTypeImpl {
        ...
        get valueType() {
            return Concept_1.Concept.ValueType.LONG;
        }
        isLong() {
            return true;
        }
    ...
    (function (Long) {
        class Remote extends AttributeTypeImpl.Remote {
            ...
            async get(value) {
                return await super.getImpl(RequestBuilder_1.RequestBuilder.Concept.conceptValueLongProto(value));
            }
            async put(value) {
                const request = RequestBuilder_1.RequestBuilder.Type.AttributeType.putReq(this.label, RequestBuilder_1.RequestBuilder.Concept.conceptValueLongProto(value));
                return await this.execute(request).then((res) => dependencies_internal_1.AttributeImpl.of(res.getAttributeTypePutRes().getAttribute()));
            }
        }
        Long.Remote = Remote;
    ...
    class Double extends AttributeTypeImpl {
        ...
        get valueType() {
            return Concept_1.Concept.ValueType.DOUBLE;
        }
        isDouble() {
            return true;
        }
    ...
    (function (Double) {
        class Remote extends AttributeTypeImpl.Remote {
            ...
            async get(value) {
                return await super.getImpl(RequestBuilder_1.RequestBuilder.Concept.conceptValueDoubleProto(value));
            }
            async put(value) {
                const request = RequestBuilder_1.RequestBuilder.Type.AttributeType.putReq(this.label, RequestBuilder_1.RequestBuilder.Concept.conceptValueDoubleProto(value));
                return await this.execute(request).then((res) => dependencies_internal_1.AttributeImpl.of(res.getAttributeTypePutRes().getAttribute()));
            }
        }
    ...
    class String extends AttributeTypeImpl {
        ...
        get valueType() {
            return Concept_1.Concept.ValueType.STRING;
        }
        isString() {
            return true;
        }
    ...
    (function (String) {
        class Remote extends AttributeTypeImpl.Remote {
            ...
            async get(value) {
                return await super.getImpl(RequestBuilder_1.RequestBuilder.Concept.conceptValueStringProto(value));
            }
            async put(value) {
                const request = RequestBuilder_1.RequestBuilder.Type.AttributeType.putReq(this.label, RequestBuilder_1.RequestBuilder.Concept.conceptValueStringProto(value));
                return await this.execute(request).then((res) => dependencies_internal_1.AttributeImpl.of(res.getAttributeTypePutRes().getAttribute()));
            }
            async getRegex() {
    ...
    class DateTime extends AttributeTypeImpl {
        ...
        get valueType() {
            return Concept_1.Concept.ValueType.DATETIME;
        }
        isDateTime() {
            return true;
        }
    ...
    (function (DateTime) {
        class Remote extends AttributeTypeImpl.Remote {
            ...
            async get(value) {
                return await super.getImpl(RequestBuilder_1.RequestBuilder.Concept.conceptValueDateTimeProto(value));
            }
            async put(value) {
                const request = RequestBuilder_1.RequestBuilder.Type.AttributeType.putReq(this.label, RequestBuilder_1.RequestBuilder.Concept.conceptValueDateTimeProto(value));
                return await this.execute(request).then((res) => dependencies_internal_1.AttributeImpl.of(res.getAttributeTypePutRes().getAttribute()));
            }
        }
