...
(function (ThingTypeImpl) {
    ...
    class Remote extends dependencies_internal_1.TypeImpl.Remote {
        ...
        getOwns(valueTypeOrAnnotationsOnly, annotations) {
            let request;
            if (!valueTypeOrAnnotationsOnly) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.getOwnsReq(this.label, []);
            }
            else if (Array.isArray(valueTypeOrAnnotationsOnly)) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.getOwnsReq(this.label, valueTypeOrAnnotationsOnly.map(a => ThingType_1.ThingType.Annotation.proto(a)));
            }
            else if (!annotations) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.getOwnsByTypeReq(this.label, valueTypeOrAnnotationsOnly.proto(), []);
            }
            else {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.getOwnsByTypeReq(this.label, valueTypeOrAnnotationsOnly.proto(), annotations.map(a => ThingType_1.ThingType.Annotation.proto(a)));
            }
            return this.stream(request)
        ...
        getOwnsExplicit(valueTypeOrAnnotationsOnly, annotations) {
            let request;
            if (!valueTypeOrAnnotationsOnly) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.getOwnsExplicitReq(this.label, []);
            }
            else if (Array.isArray(valueTypeOrAnnotationsOnly)) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.getOwnsExplicitReq(this.label, valueTypeOrAnnotationsOnly.map(a => ThingType_1.ThingType.Annotation.proto(a)));
            }
            else if (!annotations) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.getOwnsExplicitByTypeReq(this.label, valueTypeOrAnnotationsOnly.proto(), []);
            }
            else {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.getOwnsExplicitByTypeReq(this.label, valueTypeOrAnnotationsOnly.proto(), annotations.map(a => ThingType_1.ThingType.Annotation.proto(a)));
            }
            return this.stream(request)
        ...
        async setOwns(attributeType, overriddenTypeOrAnnotations, annotations) {
            let request;
            if (!overriddenTypeOrAnnotations) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.setOwnsReq(this.label, ThingType_1.ThingType.proto(attributeType), []);
            }
            else if (Array.isArray(overriddenTypeOrAnnotations)) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.setOwnsReq(this.label, ThingType_1.ThingType.proto(attributeType), overriddenTypeOrAnnotations.map(a => ThingType_1.ThingType.Annotation.proto(a)));
            }
            else if (!annotations) {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.setOwnsOverriddenReq(this.label, ThingType_1.ThingType.proto(attributeType), ThingType_1.ThingType.proto(overriddenTypeOrAnnotations), []);
            }
            else {
                request = RequestBuilder_1.RequestBuilder.Type.ThingType.setOwnsOverriddenReq(this.label, ThingType_1.ThingType.proto(attributeType), ThingType_1.ThingType.proto(overriddenTypeOrAnnotations), annotations.map(a => ThingType_1.ThingType.Annotation.proto(a)));
            }
