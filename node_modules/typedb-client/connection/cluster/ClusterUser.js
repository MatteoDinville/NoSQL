...
class ClusterUser {
    constructor(client, username, passwordExpirySeconds) {
        this._client = client;
    ...
    static of(user, client) {
        switch (user.getPasswordExpiryCase()) {
            ...
            case cluster_user_pb_1.User.PasswordExpiryCase.PASSWORD_EXPIRY_SECONDS: return new ClusterUser(client, user.getUsername(), user.getPasswordExpirySeconds());
        }
    }
    get passwordExpirySeconds() {
