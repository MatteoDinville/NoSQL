...
var RPC_METHOD_UNAVAILABLE = ErrorMessage_1.ErrorMessage.Client.RPC_METHOD_UNAVAILABLE;
...
class TypeDBClientError extends Error {
    constructor(error) {
        ...
        // TODO: clean this up once we have our own error protocol
            ...
            else if ([constants_1.Status.UNAVAILABLE, constants_1.Status.UNKNOWN, constants_1.Status.CANCELLED].includes(error.code) || error.message.includes("Received RST_STREAM")) {
