...
export declare namespace ErrorMessage {
    ...
    namespace Client {
        const RPC_METHOD_UNAVAILABLE: Client;
        const CLIENT_NOT_OPEN: Client;
        const SESSION_ID_EXISTS: Client;
        const SESSION_CLOSED: Client;
        const TRANSACTION_CLOSED: Client;
        const TRANSACTION_CLOSED_WITH_ERRORS: Client;
        ...
        const UNKNOWN_STREAM_STATE: Client;
        ...
        const CLUSTER_USER_DOES_NOT_EXIST: Client;
        const CLUSTER_TOKEN_CREDENTIAL_INVALID: Client;
        const CLUSTER_INVALID_ROOT_CA_PATH: Client;
