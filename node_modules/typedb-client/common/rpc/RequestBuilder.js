...
const connection_pb_1 = require("typedb-protocol/common/connection_pb");
const version_pb_1 = require("typedb-protocol/common/version_pb");
...
(function (RequestBuilder) {
    ...
    (function (Connection) {
        function openReq() {
            return new connection_pb_1.Connection.Open.Req().setVersion(version_pb_1.Version.VERSION);
        }
        Connection.openReq = openReq;
    })(Connection = RequestBuilder.Connection || (RequestBuilder.Connection = {}));
    let Session;
    (function (Session) {
    ...
    let Concept;
    (function (Concept) {
        function conceptValueBooleanProto(value) {
            return new concept_pb_1.ConceptValue().setBoolean(value);
        }
        Concept.conceptValueBooleanProto = conceptValueBooleanProto;
        function conceptValueLongProto(value) {
            return new concept_pb_1.ConceptValue().setLong(value);
        }
        Concept.conceptValueLongProto = conceptValueLongProto;
        function conceptValueDoubleProto(value) {
            return new concept_pb_1.ConceptValue().setDouble(value);
        }
        Concept.conceptValueDoubleProto = conceptValueDoubleProto;
        function conceptValueStringProto(value) {
            return new concept_pb_1.ConceptValue().setString(value);
        }
        Concept.conceptValueStringProto = conceptValueStringProto;
        function conceptValueDateTimeProto(value) {
            return new concept_pb_1.ConceptValue().setDateTime(value.getTime());
        }
        Concept.conceptValueDateTimeProto = conceptValueDateTimeProto;
    })(Concept = RequestBuilder.Concept || (RequestBuilder.Concept = {}));
    let Type;
    (function (Type) {
        ...
        (function (ThingType) {
            ...
            function getOwnsReq(label, annotations) {
                return typeReq(newReqBuilder(label).setThingTypeGetOwnsReq(new concept_pb_1.ThingType.GetOwns.Req().setAnnotationsList(annotations)));
            }
            ThingType.getOwnsReq = getOwnsReq;
            function getOwnsByTypeReq(label, valueType, annotations) {
                return typeReq(newReqBuilder(label).setThingTypeGetOwnsReq(new concept_pb_1.ThingType.GetOwns.Req().setAnnotationsList(annotations)
                    .setValueType(valueType)));
            }
            ThingType.getOwnsByTypeReq = getOwnsByTypeReq;
            function getOwnsExplicitReq(label, annotations) {
                return typeReq(newReqBuilder(label).setThingTypeGetOwnsExplicitReq(new concept_pb_1.ThingType.GetOwnsExplicit.Req().setAnnotationsList(annotations)));
            }
            ThingType.getOwnsExplicitReq = getOwnsExplicitReq;
            function getOwnsExplicitByTypeReq(label, valueType, annotations) {
                return typeReq(newReqBuilder(label).setThingTypeGetOwnsExplicitReq(new concept_pb_1.ThingType.GetOwnsExplicit.Req().setAnnotationsList(annotations)
                    .setValueType(valueType)));
            }
            ThingType.getOwnsExplicitByTypeReq = getOwnsExplicitByTypeReq;
            function setOwnsReq(label, attributeType, annotations) {
            ...
            function setOwnsOverriddenReq(label, attributeType, overriddenType, annotations) {
                return typeReq(newReqBuilder(label).setThingTypeSetOwnsReq(new concept_pb_1.ThingType.SetOwns.Req()
                    .setAttributeType(attributeType)
        ...
        (function (AttributeType) {
            function getOwnersReq(label, annotations) {
                return typeReq(newReqBuilder(label).setAttributeTypeGetOwnersReq(new concept_pb_1.AttributeType.GetOwners.Req().setAnnotationsList(annotations)));
            }
            AttributeType.getOwnersReq = getOwnersReq;
            function getOwnersExplicitReq(label, annotations) {
                return typeReq(newReqBuilder(label).setAttributeTypeGetOwnersExplicitReq(new concept_pb_1.AttributeType.GetOwnersExplicit.Req().setAnnotationsList(annotations)));
            }
        ...
        let Annotation;
        (function (Annotation) {
            function annotationKeyProto() {
                return new concept_pb_1.Type.Annotation().setKey(new concept_pb_1.Type.Annotation.Key());
            }
            Annotation.annotationKeyProto = annotationKeyProto;
            function annotationUniqueProto() {
                return new concept_pb_1.Type.Annotation().setUnique(new concept_pb_1.Type.Annotation.Unique());
            }
            Annotation.annotationUniqueProto = annotationUniqueProto;
    ...
    (function (Thing) {
        ...
        function getHasReqByAnnotations(iid, annotations) {
            return thingReq(new concept_pb_1.Thing.Req().setIid(Bytes_1.Bytes.hexStringToBytes(iid)).setThingGetHasReq(new concept_pb_1.Thing.GetHas.Req().setAnnotationsList(annotations)));
        }
        Thing.getHasReqByAnnotations = getHasReqByAnnotations;
