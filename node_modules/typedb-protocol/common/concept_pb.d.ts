...
export namespace ConceptManager {
    ...
    export namespace PutAttributeType {
        ...
        export class Req extends jspb.Message { 
            ...
            setValueType(value: ValueType): Req;
...
export class Thing extends jspb.Message { 
    ...
    hasValue(): boolean;
    clearValue(): void;
    getValue(): ConceptValue | undefined;
    setValue(value?: ConceptValue): Thing;
    getInferred(): boolean;
...
export namespace Thing {
    ...
    export namespace GetHas {
        ...
        export class Req extends jspb.Message { 
            ...
            getAnnotationsList(): Array<Type.Annotation>;
            setAnnotationsList(value: Array<Type.Annotation>): Req;
            addAnnotations(value?: Type.Annotation, index?: number): Type.Annotation;
        ...
        export namespace Req {
            export type AsObject = {
                ...
                annotationsList: Array<Type.Annotation.AsObject>,
            }
        }
...
export class Value extends jspb.Message { 
    getValueType(): ValueType;
    setValueType(value: ValueType): Value;

    hasValue(): boolean;
    clearValue(): void;
    getValue(): ConceptValue | undefined;
    setValue(value?: ConceptValue): Value;
...
export class ConceptValue extends jspb.Message { 

    hasString(): boolean;
    clearString(): void;
    getString(): string;
    setString(value: string): ConceptValue;

    hasBoolean(): boolean;
    clearBoolean(): void;
    getBoolean(): boolean;
    setBoolean(value: boolean): ConceptValue;

    hasLong(): boolean;
    clearLong(): void;
    getLong(): number;
    setLong(value: number): ConceptValue;

    hasDouble(): boolean;
    clearDouble(): void;
    getDouble(): number;
    setDouble(value: number): ConceptValue;

    hasDateTime(): boolean;
    clearDateTime(): void;
    getDateTime(): number;
    setDateTime(value: number): ConceptValue;

    getValueCase(): ConceptValue.ValueCase;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): ConceptValue.AsObject;
    static toObject(includeInstance: boolean, msg: ConceptValue): ConceptValue.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ConceptValue, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ConceptValue;
    static deserializeBinaryFromReader(message: ConceptValue, reader: jspb.BinaryReader): ConceptValue;
}

export namespace ConceptValue {
    export type AsObject = {
        string: string,
        pb_boolean: boolean,
        pb_long: number,
...
export class Type extends jspb.Message { 
    ...
    getValueType(): ValueType;
    setValueType(value: ValueType): Type;
    getIsRoot(): boolean;
...
export namespace Type {
    ...
    export class Annotation extends jspb.Message { 
        ...
        hasKey(): boolean;
        clearKey(): void;
        getKey(): Type.Annotation.Key | undefined;
        setKey(value?: Type.Annotation.Key): Annotation;

        hasUnique(): boolean;
        clearUnique(): void;
        getUnique(): Type.Annotation.Unique | undefined;
        setUnique(value?: Type.Annotation.Unique): Annotation;

        getAnnotationCase(): Annotation.AnnotationCase;
    ...
    export namespace Annotation {
        export type AsObject = {
            key?: Type.Annotation.Key.AsObject,
            unique?: Type.Annotation.Unique.AsObject,
        }
        ...
        export class Unique extends jspb.Message { 

            serializeBinary(): Uint8Array;
            toObject(includeInstance?: boolean): Unique.AsObject;
            static toObject(includeInstance: boolean, msg: Unique): Unique.AsObject;
            static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
            static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
            static serializeBinaryToWriter(message: Unique, writer: jspb.BinaryWriter): void;
            static deserializeBinary(bytes: Uint8Array): Unique;
            static deserializeBinaryFromReader(message: Unique, reader: jspb.BinaryReader): Unique;
        }
...
export namespace AttributeType {
    ...
    export namespace Put {
        ...
        export class Req extends jspb.Message { 
            ...
            clearValue(): void;
            getValue(): ConceptValue | undefined;
            setValue(value?: ConceptValue): Req;
